<div class="mim-fnt bg-white flex flex-col min-h-screen w-full" xmlns:wire="http://www.w3.org/1999/xhtml">
    <div>
        <div class="bg-gray-200 px-4 py-4">
            ...
            >
                ...
                @else
                    <div class="">
                        <a href="#"
                           class="inline-block py-2 px-4 text-gray-700 bg-white hover:bg-gray-100 rounded-lg mr-6 shadow-2xl">
{{--                            <i class="feather-settings"></i>--}}
                            {{auth()->user()->name}}
                        </a>
                        <a href="#" wire:click="logout"
                           class="inline-block py-2 px-4 text-gray-700 bg-white hover:bg-gray-100 rounded-lg shadow-2xl">
        ...
        <div class="bg-gray-200 md:overflow-hidden">
            <div class="px-4 py-16">
                <div class="relative w-full md:max-w-2xl md:mx-auto text-center">
                    ...
                    <h1
                        class="text-gray-600 md:text-xl md:px-18 leading-tight mb-6 italic"
                    >
                    ...
                    <p class="text-md text-indigo-500 font-bold text-right">
                        Arthur Ashe
                    </p>
